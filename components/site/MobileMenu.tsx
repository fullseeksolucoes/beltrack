...
export default function MobileMenu({ open, onClose }: MobileMenuProps) {
  ...
  return (
    <div className="fixed inset-x-0 top-16 md:top-20 z-50 md:hidden border-t border-border bg-white" role="dialog" aria-modal="true" aria-label="Menu de navegação">
